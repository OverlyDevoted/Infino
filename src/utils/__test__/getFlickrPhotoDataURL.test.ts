...
describe('getFlickrPhotoDataURL', () => {
  it('should return a correctly formatted URL for photo data retrieval from Flickr', () => {
    ...
    expect(url).toBe(
      'https://www.flickr.com/services/rest/?api_key=3018234adaa28f4f4bc702a311869836&format=json&method=flickr.photos.search&per_page=12&text=garden&page=1&nojsoncallback=1'
    );
  });
